"""
Django settings for ClientM project.
...
SECRET_KEY = 'django-insecure-eslagt(^kk8s)q-80(md0y$ely%j9#f3i*7vi522k_qsa2*=o_'
...
WSGI_APPLICATION = 'ClientM.wsgi.application'
...
EMAIL_HOST = 'smtp.google.com'  # Specify your SMTP server address
...
CORS_ALLOWED_ORIGINS = [
   'https://client-management-u8xd.onrender.com',
